...
gear1_teeth = 20;
gear1_shaft_d = 20;  			// diameter of motor shaft
...
gear1_setscrew_offset = 7;			// Distance from motor on motor shaft.
	...
	else
	{
		...
		union()
		{
			...
			difference()
			{
				...
				translate([0,0,gear_h])	cylinder(h=gear_shaft_h, r=gear2_shaft_outer_r+5);
			}
